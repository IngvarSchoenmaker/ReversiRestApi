...
namespace ReversiRestApi.Interfaces
{
    ...
    {
        int ID { get; set; }
        string Omschrijving { get; set; } //het unieke token van het spel 
        ...
        bool Pas(); 
        bool Afgelopen(); //welke kleur het meest voorkomend op het speelbord 
        Kleur OverwegendeKleur(); //controle of op een bepaalde positie een zet mogelijk is 
